...
Specifically, if we assume random witness selection, and that Alice is colluding with fraction $ f $ of all witnesses in the network, the probability that $ tx_a $ will not be executed while $ tx_b $ can be modelled as follows:\todo{derive}
